        ...
        <Row className="about-content">
          ...
          <Col className="right" xs={24} sm={24} md={12} lg={12} xl={12}>
            <Animate.FadeInDown>
              ...
              <h3 className="title">Best Minh's  store online</h3>
              <p className="description">
                Minh's  store.com accepts online orders and has home delivery. DO
                NOT support ordering and receiving directly Minh's  store.com
                ...
                all Minh's  store systems nationwide at the office as well as all
                Minh's  store systems nationwide
              </p>
            </Animate.FadeInDown>
